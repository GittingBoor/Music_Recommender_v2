...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('background_score', sa.Float(), nullable=True),
        sa.Column('active_score', sa.Float(), nullable=True),
        sa.Column('engagement_timeseries', postgresql.ARRAY(sa.Float()), nullable=True),
        sa.Column('instrumental_score', sa.Float(), nullable=True),
        sa.Column('vocal_score', sa.Float(), nullable=True),
        sa.Column('voice_timeseries', postgresql.ARRAY(sa.Float()), nullable=True),
        sa.Column('female_score', sa.Float(), nullable=True),
        sa.Column('male_score', sa.Float(), nullable=True),
